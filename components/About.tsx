        ...
        <motion.img
          ...
          <div className='space-y-10 px-0 md:px-10'>
            ...
            <p className='text-base'>
              Hi there,my name is Abdulhamid Medi(yes, like late Koffi Annan the mediator) Nassur.I am a Software Engineer previous worked at Eclectics International as Fullstack developer.Majorly in Angular and Nextjs on the frontend.
